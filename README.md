...
The repository retains one legible path from human judgment to production output:
...
7. Build aggregate tables and test descriptive hypotheses with within-occupation robustness checks.

See `docs/pipeline.md` for inputs, outputs, and the rationale for every retained script.
